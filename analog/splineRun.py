			...
			if type == 1 or type == 2:
				...
				if dataIMU==1:
                                        if IMU_cycleCounter == IMU_cycleThreshold:
                                                ...
                                                dataWrite = [currentTimeD.total_seconds(), \
                                                currentEditedReading[0][0], currentEditedReading[0][1], \
                                                currentEditedReading[0][2], currentEditedReading[1][0], \
                                                currentEditedReading[1][1], currentEditedReading[1][2], \
                                                chassisOutput1, tibiaOutput1, chassisOutput2, tibiaOutput2, \
